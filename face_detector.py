...
from skimage.color import rgba2rgb  # Thêm import ở đầu tệp nếu cần
...
class BaseDetector:
    ...
    def detect_in_image(self, image, max_output_size=15, iou_threshold=0.45, score_threshold=0.25, image_format="RGB"):
        ...
        # Chuyển ảnh RGBA về RGB nếu cần
        if image.shape[2] == 4:
...
# python face_detector.py D:/CODE/PYTHON/Do_an/v2/GhostFaceNets/213.jpg
# python face_detector.py D:/CODE/PYTHON/Do_an/v2/GhostFaceNets/datasets/ms1m-retinaface-t1_112x112_folders

# Nếu muốn dùng SCRFD thay vì YoloV5, thêm --use_scrfd:
# python face_detector.py D:/CODE/PYTHON/Do_an/v2/GhostFaceNets/213.jpg --use_scrfd
